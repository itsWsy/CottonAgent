...
async function addRecord(data) { await store.createRecord(Number(route.params.id), data) }
async function removeRecord(record) { await store.deleteRecord(record.id, Number(route.params.id)) }
onMounted(async () => {
